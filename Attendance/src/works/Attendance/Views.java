...
public class Views extends Activity {
	...
	String spitem;
	Button speak,enter,ok,date,from,to;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		enter=(Button)findViewById(R.id.takeenter);
			...
			private void savedata() {
				...
				String str = "";
				 ...
				 try{							
						 ...
						 db.update((String)sp.getSelectedItem(), cv,"id="+id+"", new String []{});
						 makearrange();
						 unaccess();
